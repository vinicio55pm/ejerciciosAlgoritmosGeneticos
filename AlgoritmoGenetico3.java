 ...
 * @author Vinnys
 */
public class AlgoritmoGenetico3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(miFuncion(18));
        System.out.println(miFuncionDerivada1(18));
        System.out.println(miFuncionDerivada2(18));
