 ...
 * @author Vinnys
 */
public class AlgoritmosGeneticos4{
    public static int numeroIndividuos=10;
    public static int numeroInteraciones=40;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(miFuncion(707.11));
        System.out.println(miFuncionDerivada1(707.11));
        System.out.println(miFuncionDerivada2(707.11));
    ...
    public static void generarPoblacion(){
        ...
        for (int i = 0; i < numeroIndividuos; i++) {
            ...
            individuo.genoma=((int)(Math.random() * 1023-1)+1);
    ...
    public static void generarFitness(){
        ...
        for (int i = 0; i < tamaño; i++) {
            ...
            individuo.fitness= miFuncion(geno);
    ...
    public static double miFuncion(double p){
        return (100000/p)+1500+0.2*p;
    }
    public static double miFuncionDerivada1(double p){
        return (100000/p*p)-0.2;
    }
    public static double miFuncionDerivada2(double p){
        return (200000/p*p*p);
    }
